...
import PortfolioIcon from "@/common/svg/PortfolioIcon";
  ...
  return (
    <section className="text-white">
      <div>
        ...
        <div className="uppercase font-semibold mb-3 pl-2 text-2xl">
          Personal infos
        </div>
        ...
        <div className="grid grid-cols-2 pt-[15px] items-center justify-items-center">
        ...
        <div className="grid grid-cols-2 gap-5 justify-items-center pt-5">
          <div className="col-span-1 border-2 border-primary-gray min-w-[150px] p-5">
        ...
        <div>
          ...
          <div className="grid grid-cols-2">
            <div className="lg:col-span-1 col-span-2 flex flex-col gap-3">
              <div>
                <div>
                    <PortfolioIcon width="24" height="24" style="fill-white" />
                </div>
                <div className="flex flex-col gap-y-[5px] py-[20px]">
