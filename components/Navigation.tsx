    ...
    <div className="fix right-[10px] top-[20%] w-fit h-screen">
      <div className="grid grid-cols-1 justify-evenly items-center gap-y-[50px]">
        <div className="col-span-1 flex justify-between hover:bg-primary-yellow">
          <p className="uppercase hidden text-white hover:block font-bold">Home</p>
        ...
        <div className="col-span-1 flex justify-between items-center hover:bg-primary-yellow">
          <p className="uppercase hidden text-white hover:block font-bold hover:bg-primary-yellow">About</p>
          <Image width={24} height={24} src="/assets/svg/about.svg" alt="about-section" />
        </div>
        <div className="col-span-1 flex justify-between items-center hover:bg-primary-yellow">
          <p className="uppercase hidden text-white hover:block font-bold hover:bg-primary-yellow">PortFolio</p>
          <Image width={24} height={24} src="/assets/svg/portfolio.svg" alt="portfolio-section" />
        </div>
        <div className="col-span-1 flex justify-between items-center hover:bg-primary-yellow">
          <p className="uppercase hidden text-white hover:block font-bold hover:bg-primary-yellow">Contact</p>
          <Image width={24} height={24} src="/assets/svg/mail.svg" alt="contact-section" />
        </div>
        <div className="col-span-1 flex justify-between items-center hover:bg-primary-yellow">
          <p className="uppercase hidden text-white hover:block font-bold hover:bg-primary-yellow">Blog</p>
